      ...
      <div class="font-bold text-orange-100 text-3xl sm:text-4xl mb-6 items-center justify-center drop-shadow-xl">
        ...
        <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
          ...
          <div class="bg-black/30 border-black/30 border-2 p-8 rounded-xl">
            ...
            <a href="/discord" class="transition duration-200 rounded-xl bg-red-700/80 hover:bg-red-700 border-red-700 border-2 px-6 py-3 font-bold text-red-100 text-lg whitespace-nowrap">
              Discord
            </a>
          </div>
          <div class="bg-black/30 border-black/30 border-2 p-8 rounded-xl">
          ...
          <div class="bg-black/30 border-black/30 border-2 p-8 rounded-xl">
            ...
            <a href="https://netherdepths.tebex.io" class="transition duration-200 rounded-xl bg-red-700/80 hover:bg-red-700 border-red-700 border-2 px-6 py-3 font-bold text-red-100 text-lg whitespace-nowrap">
                Learn More...
            </a>
          </div>
          <div class="bg-black/30 border-black/30 border-2 p-8 rounded-xl">

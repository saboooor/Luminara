    ...
    <section class="flex mx-auto px-6 items-center justify-center text-center" style="min-height: calc(100lvh - 64px);">
      <div class="p-10 sm:p-16 drop-shadow-xl rounded-xl text-orange-100 max-w-sm sm:max-w-xl md:max-w-2xl lg:max-w-4xl xl:max-w-6xl">
        <h1 class="font-bold text-3xl sm:text-5xl mb-3 shadow-outline">
          Vote for <span class="text-luminescent-500">Luminara SMP!</span>
        </h1>
        ...
        <div class="mt-6 mb-12 flex flex-wrap gap-3 justify-center">
          <a href="https://bit.ly/NetherVote-MCSL" class="flex transition rounded-xl bg-luminescent-600/80 hover:bg-luminescent-600 border-luminescent-600 border px-6 py-3 font-bold text-luminescent-100 md:py-4 md:px-8 md:text-lg whitespace-nowrap justify-center">
            MCSL
          </a>
          <a href="https://bit.ly/NetherVote-MCSO" class="flex transition rounded-xl bg-luminescent-600/80 hover:bg-luminescent-600 border-luminescent-600 border px-6 py-3 font-bold text-luminescent-100 md:py-4 md:px-8 md:text-lg whitespace-nowrap justify-center">
            MCSO
          </a>
          <a href="https://bit.ly/NetherVote-MCSN" class="flex transition rounded-xl bg-luminescent-600/80 hover:bg-luminescent-600 border-luminescent-600 border px-6 py-3 font-bold text-luminescent-100 md:py-4 md:px-8 md:text-lg whitespace-nowrap justify-center">
            MCSN
          </a>
          <a href="https://bit.ly/NetherVote-MCMP" class="flex transition rounded-xl bg-luminescent-600/80 hover:bg-luminescent-600 border-luminescent-600 border px-6 py-3 font-bold text-luminescent-100 md:py-4 md:px-8 md:text-lg whitespace-nowrap justify-center">
            MCMP
          </a>
          <a href="https://bit.ly/NetherVote-MCPS" class="flex transition rounded-xl bg-luminescent-600/80 hover:bg-luminescent-600 border-luminescent-600 border px-6 py-3 font-bold text-luminescent-100 md:py-4 md:px-8 md:text-lg whitespace-nowrap justify-center">
            MCPS
          </a>
          <a href="https://bit.ly/NetherVote-SMCN" class="flex transition rounded-xl bg-luminescent-600/80 hover:bg-luminescent-600 border-luminescent-600 border px-6 py-3 font-bold text-luminescent-100 md:py-4 md:px-8 md:text-lg whitespace-nowrap justify-center">
            SMCN
          </a>
        ...
        <p class="mb-6 shadow-outline">
          ...
          <span class="text-luminescent-500">You must allow pop-ups in your browser for it to function properly.</span>
        </p>
        ...
        <div class="mt-6 mb-12 flex flex-wrap gap-3 justify-center">
          ...
          }} class="flex transition rounded-xl bg-luminescent-600/80 hover:bg-luminescent-600 border-luminescent-600 border px-6 py-3 font-bold text-luminescent-100 md:py-4 md:px-8 md:text-lg whitespace-nowrap justify-center">
            Open vote sites
          </button>
        </div>
      </div>

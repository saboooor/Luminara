...
export default component$(() => {
  return (
    <>
      <section class="mx-auto backdrop-blur-2xl bg-black/30 outline outline-2 outline-black/30 rounded-xl max-w-sm sm:max-w-xl md:max-w-2xl lg:max-w-4xl xl:max-w-6xl mb-16 mt-24">
        <div class="font-bold text-orange-100 text-2xl sm:text-3xl mb-6 p-10 xl:p-16 items-center justify-center">
          <div class="mb-8 sm:mb-16">
            ...
            <p class="font-normal text-xl">
              Please note that the staff have full control over what may be allowed and what is not, things may differ as there may be gray areas.
            </p>
            <p class="font-normal text-xl">
              Attempting to exploit gray areas is not permitted and will end up in a punishment regardless of what the rules indicate.
            </p>
            <p class="font-normal text-xl">
          ...
          <div class="grid gap-10">
            <div class="grid gap-10 lg:grid-cols-2">
              <div class="text-lg font-normal">
                <h2 class="text-xl sm:text-2xl">1. Grief</h2>
              ...
              <div class="text-lg font-normal">
                <h2 class="text-xl sm:text-2xl">2. Sensitivity</h2>
              ...
              <div class="text-lg font-normal">
                <h2 class="text-xl sm:text-2xl">3. Language</h2>
              ...
              <div class="text-lg font-normal">
                <h2 class="text-xl sm:text-2xl">4. Player Killing</h2>
              ...
              <div class="text-lg font-normal">
                <h2 class="text-xl sm:text-2xl">5. Impersonation</h2>
              ...
              <div class="text-lg font-normal">
                <h2 class="text-xl sm:text-2xl">6. Building</h2>
              ...
              <div class="text-lg font-normal">
                <h2 class="text-xl sm:text-2xl">7. Spam</h2>
            ...
            <div class="text-lg font-normal">
              <h2 class="text-xl sm:text-2xl">11. Behaviour</h2>
            ...
            <div class="text-lg font-normal">
              <h2 class="text-xl sm:text-2xl">12. Privacy</h2>
            ...
            <div class="text-lg font-normal">
              <h2 class="text-xl sm:text-2xl">13. Inclusivity</h2>
            ...
            <div class="text-lg font-normal">
              <h2 class="text-xl sm:text-2xl">14. Plugin Rules</h2>

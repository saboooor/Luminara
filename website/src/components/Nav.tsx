  ...
  return (
    <Nav floating fixed colorClass="lum-bg-nav-bg !text-gray-100">
      ...
      <Link q:slot="mobile" href="/announcements" class={{
        'lum-btn lum-bg-transparent rounded-lum-1 hover:lum-bg-nav-bg': true,
      }}>
        <Bell size={24} /> Announcements
      </Link>
      ...
      <SelectMenuRaw id="nav-resources" q:slot='mobile' customDropdown
        class={{ 'lum-bg-transparent rounded-lum-1 hover:lum-bg-nav-bg': true }}
        panelClass='lum-bg-nav-bg'>
        <div q:slot="dropdown" class="flex items-center gap-2">
          <Menu size={24} />
          More
...
export const SocialButtons = component$(() => {
  return <>
    <a href="https://luminara.tebex.io" title="Store" class="lum-btn lum-bg-transparent p-2 rounded-lum-1 hover:lum-bg-nav-bg">

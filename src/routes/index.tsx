    ...
    <>
      <div class="flex flex-col h-[calc(100svh-80px)] justify-center items-center">
        <div class="flex flex-col justify-center items-center lg:gap-[25svh] gap-5">
          ...
          <div class="sm:grid grid-cols-2 lg:grid-cols-3 gap-10 mx-auto drop-shadow-2xl">
            <button onClick$={() => {
          ...
          <div class="flex flex-col sm:flex-row flex-1 gap-5 w-full sm:w-3/4 max-w-7xl px-10 sm:px-0 mx-auto justify-center my-10 sm:items-center text-2xl lg:text-3xl hover:text-white drop-shadow-xl">
            ...
            <div class="flex flex-col lg:flex-row w-full justify-between gap-4">
              <a href="/discord" class="flex gap-5 lg:gap-10 lg:flex-col items-center transition-all duration-500 hover:duration-200 group lg:hover:scale-110 lg:hover:translate-y-2 hover:drop-shadow-2xl hover:saturate-150">
                <LogoDiscord class="text-indigo-400 transition-all duration-500 group-hover:duration-300 lg:group-hover:-translate-y-5 w-12 h-12 lg:w-44 lg:h-44" />
                Discord
              </a>
              <Link href="/announcements" class="flex gap-5 lg:gap-10 lg:flex-col items-center transition-all duration-500 hover:duration-200 group lg:hover:scale-110 lg:hover:translate-y-2 hover:drop-shadow-2xl hover:saturate-150">
              ...
              <a href="https://netherdepths.tebex.io" class="flex gap-5 lg:gap-10 lg:flex-col items-center transition-all duration-500 hover:duration-200 group lg:hover:scale-110 lg:hover:translate-y-2 hover:drop-shadow-2xl hover:saturate-150">
                <Cart class="transition-all duration-500 group-hover:duration-300 lg:group-hover:-translate-y-5 w-12 h-12 lg:w-44 lg:h-44" />
                Store
              </a>
              <Link href="/vote" class="flex gap-5 lg:gap-10 lg:flex-col items-center transition-all duration-500 hover:duration-200 group lg:hover:scale-110 lg:hover:translate-y-2 hover:drop-shadow-2xl hover:saturate-150">
                <Keys class="transition-all duration-500 group-hover:duration-300 lg:group-hover:-translate-y-5 w-12 h-12 lg:w-44 lg:h-44" />
                Vote
              </Link>
              <Link href="/rules" class="flex gap-5 lg:gap-10 lg:flex-col items-center transition-all duration-500 hover:duration-200 group lg:hover:scale-110 lg:hover:translate-y-2 hover:drop-shadow-2xl hover:saturate-150">
